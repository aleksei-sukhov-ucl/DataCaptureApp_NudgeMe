...
/// [StatefulWidget] that takes displays an animated, circular representation of
/// a score
class WellbeingCircle2 extends StatefulWidget {
  /// 0 <= score <= 10 that determines how much positive/negative color to show
  final int score;

  /// takes an [int] score which could be null
  const WellbeingCircle2({this.score});

  @override
  _WellbeingCircleState2 createState() => _WellbeingCircleState2();
}

class _WellbeingCircleState2 extends State<WellbeingCircle2> {
  int _currScore = 0;
    ...
    final bgCircle = AnimatedContainer(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
            ...
            colors: [Colors.amberAccent.shade400, Colors.transparent],
            // cumulative points to switch color:
            stops: [purpleFraction, blueStartPoint]),
        shape: BoxShape.circle,
        boxShadow: boxShadows,
